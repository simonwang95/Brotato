...
> 2026-08-30 状态提示：本文生成于最新安全与产品审查之前。开始新一轮功能或模型工作前，应先完成 [修复与优化计划](remediation-plan.md) 的第一批安全热修，至少处理 P0-1、P0-2 和 P1-1。OCR 仍暂停功能扩展，但其现有服务器与接口安全边界需要先修复。
